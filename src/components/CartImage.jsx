...
export default function Footer() {
  ...
  const handleSubscribe = async (e) => {
    ...
    if (!email) return;
    try {
      // You can later insert into a newsletters table if needed
      setSubscribed(true);
      setEmail('');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-6">
              <Link to="/" className="inline-block">
                <img src="/logo_minalgems.png" alt="Minalgems" className="h-14 w-auto" />
              </Link>
          ...
          <div className="mt-16 pt-8 border-t border-gold-200 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              ...
              <p className="text-xs text-gold-500 mt-1">
                ...
                <a href="https://www.exotech.co.in" target="_blank" rel="noopener noreferrer" className="text-gold-600 hover:text-gold-700 font-semibold">
                  Exotech Developers
                </a>
              </p>
            </div>
